...
class FreeFireInCodePreview extends StatelessWidget {
  FreeFireInCodePreview({Key? key}) : super(key: key);
  ...
  _paymentReceiptWidget(BuildContext context) {
    final total =data[3]+1.00;
    return Column(
      children: [
        spaceBetTextWidget(Strings.playerID, data[0]),
        spaceBetTextWidget(Strings.rechargeType, data[1]),
