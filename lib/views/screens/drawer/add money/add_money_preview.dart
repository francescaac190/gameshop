...
class AddMoneyPreview extends StatelessWidget {
  AddMoneyPreview({Key? key}) : super(key: key);
  ...
  _paymentReceiptWidget(BuildContext context) {
    ...
    final total =amount+5.00;

    return Column(
      children: [
        spaceBetTextWidget(Strings.amount, '$amount USD'),
        spaceBetTextWidget(Strings.charge, '5.0 USD'),
        spaceBetTextWidget(Strings.payableAmount, '$total USD'),
        spaceBetTextWidget(Strings.paymentMethod, data[0]),
      ],
    );
  }
}
